 ...
 */
public class SubtitleItem2 extends TextItem {
     ...
     * @hide
     */
    public SubtitleItem2() {
    }

    /**
     * Construct a new SubtitleItem2 with the specified text and subtitle.
     * 
     * @param text The text for this item
     * @param subtitle The item's subtitle
     */
    public SubtitleItem2(String text, String subtitle, String subsubtitle) {
        super(text);
        this.subtitle = subtitle;
        this.subtitle2 = subsubtitle;
    }

    @Override
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, R.layout.gd_subtitle_item_view2, parent);
    }
